...
class ResponseDialogItemWidget extends StatelessWidget {
  ...
  const ResponseDialogItemWidget({
    Key? key,
        ...
        child: Container(
          ...
          child:  Column(
            children: [
             ...
             Padding(padding:EdgeInsets.symmetric(horizontal:10, ),child:  RoundedButton(
               text: buttonTitle,
